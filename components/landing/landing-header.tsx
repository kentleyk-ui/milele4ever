          ...
          <Link href="/" className="flex items-center space-x-2 group">
            <div className="relative">
              <svg
                ...
                viewBox="0 0 24 24"
                className="h-9 w-9 heart-logo-glow"
              >
                <defs>
              ...
              {/* Effet de halo lumineux animé */}
              <div className="absolute inset-0 rounded-full bg-green-400/30 blur-md animate-pulse scale-110" style={{ animationDuration: '2s' }} />
            </div>
