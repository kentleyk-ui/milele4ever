...
export default function PetsPage() {
  // Since this is a Server Component, we can't use useI18n directly
  // We'll need to make it a client component if we want translations
  ...
  return (
    <div className="relative min-h-screen flex flex-col">
      ...
      <div 
        ...
        style={{ backgroundImage: "url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/sultan.png-iqBS32elPja5ZJw0MeS1koZ04pNP6L.jpeg')" }}
      >
      ...
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        <footer className="p-4 text-center">
          <p className="text-xs text-muted-foreground">
            Product Owner - Kent Ley_CEO © {new Date().getFullYear()} Milele. Tous droits reserves.
          </p>
        </footer>
      </div>
    </div>
